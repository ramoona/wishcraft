/*
  ...
  - The values [RESERVED] on the enum `WishStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "WishStatus_new" AS ENUM ('ACTIVE', 'FULFILLED', 'ARCHIVED');
